...
register_activation_hook(__FILE__, 'simple_optimizer_cleanup_options');
...
function simple_optimizer_cleanup_options(){

	delete_option('simple_optimizer_plugin');
	delete_option('simple_optimizer_installed');
